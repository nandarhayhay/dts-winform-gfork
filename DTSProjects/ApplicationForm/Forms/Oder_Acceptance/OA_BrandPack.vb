...
#Region " Deklarasi "
    ...
    Private WithEvents frmAdjDPD As AdjDPDQTY
#End Region
...
#End Region
    ...
    Private Sub ReadAcces()
        If Not Me.CMAin.IsSystemAdministrator Then
            If NufarmBussinesRules.User.Privilege.ALLOW_DELETE.OA_BrandPack = True Then
            ...
            End If
            If (NufarmBussinesRules.User.Privilege.ALLOW_INSERT.OA_BrandPack = True) And (NufarmBussinesRules.User.Privilege.ALLOW_UPDATE.OA_BrandPack = True) Then
            ElseIf NufarmBussinesRules.User.Privilege.ALLOW_INSERT.OA_BrandPack = True Then
                ...
                Me.btnGenerateAgreement.Visible = True
                Me.btnGenerateMarketing.Visible = True
                Me.btnSetOtherDiscount.Visible = True
            ElseIf NufarmBussinesRules.User.Privilege.ALLOW_UPDATE.OA_BrandPack = True Then
                Me.ButtonEntry1.btnInsert.Visible = True
            ...
            Else
                ...
                Me.btnGenerateMarketing.Visible = False
                Me.btnGenerateAgreement.Visible = False
                Me.btnSetOtherDiscount.Visible = False
            End If
        End If
    ...
    Private Function DeleteOA_BrandPack_Disc() As Integer
        ...
        Dim OA_BRANDPACK_ID As Object = Me.GridEX1.GetValue("OA_BRANDPACK_ID").ToString()
        ...
        Try
            ...
            If (Not IsNothing(Me.GridEX2.GetValue("AGREE_DISC_HIST_ID"))) And (Not (TypeOf (Me.GridEX2.GetValue("AGREE_DISC_HIST_ID")) Is DBNull)) Then
                If Not String.IsNullOrEmpty(Me.GridEX2.GetValue("AGREE_DISC_HIST_ID").ToString()) Then
                    Me.clsOADiscount.DeleteOA_BRANDPACK_DISC(OA_BRANDPACK_DISC_ID, NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.AgreementDiscount, _
                    OA_BRANDPACK_DISC_QTY, Me.GridEX2.GetValue("AGREE_DISC_HIST_ID"), , , False, OA_BRANDPACK_ID)
                End If
            ElseIf (Not IsNothing(Me.GridEX2.GetValue("MRKT_DISC_HIST_ID"))) And (Not IsDBNull(Me.GridEX2.GetValue("MRKT_DISC_HIST_ID"))) Then
                Me.clsOADiscount.DeleteOA_BRANDPACK_DISC(OA_BRANDPACK_DISC_ID, NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.MarketingDiscount, _
                OA_BRANDPACK_DISC_QTY, , Me.GridEX2.GetValue("MRKT_DISC_HIST_ID").ToString(), , False, OA_BRANDPACK_ID)
            ElseIf (Not IsNothing(Me.GridEX2.GetValue("PROJ_DISC_HIST_ID"))) And (Not IsDBNull(Me.GridEX2.GetValue("PROJ_DISC_HIST_ID"))) Then
                Me.clsOADiscount.DeleteOA_BRANDPACK_DISC(OA_BRANDPACK_DISC_ID, NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.ProjectDiscount, _
                OA_BRANDPACK_DISC_QTY, , , Me.GridEX2.GetValue("PROJ_DISC_HIST_ID").ToString(), False, OA_BRANDPACK_ID)
            ElseIf (Not IsNothing(Me.GridEX2.GetValue("BRND_B_S_ID"))) And (Not IsDBNull(Me.GridEX2.GetValue("BRND_B_S_ID"))) Then
                Me.clsOADiscount.DeleteOA_BRANDPACK_DISC(OA_BRANDPACK_DISC_ID, NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.AgreementDiscount, _
                OA_BRANDPACK_DISC_QTY, , , , False, OA_BRANDPACK_ID, Me.GridEX2.GetValue("BRND_B_S_ID").ToString())
            ElseIf (Not IsNothing(Me.GridEX2.GetValue("MRKT_M_S_ID"))) And (Not IsDBNull(Me.GridEX2.GetValue("MRKT_M_S_ID"))) Then
                Me.clsOADiscount.DeleteOA_BRANDPACK_DISC(OA_BRANDPACK_DISC_ID, NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.MarketingDiscount, _
                OA_BRANDPACK_DISC_QTY, , , , False, OA_BRANDPACK_ID, , , Me.GridEX2.GetValue("MRKT_M_S_ID").ToString())
            ElseIf (Not IsNothing(Me.GridEX2.GetValue("ACHIEVEMENT_BRANDPACK_ID"))) And (Not IsDBNull(Me.GridEX2.GetValue("ACHIEVEMENT_BRANDPACK_ID"))) Then
                Me.clsOADiscount.DeleteOA_BRANDPACK_DISC(OA_BRANDPACK_DISC_ID, NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.AgreementDiscount, _
                OA_BRANDPACK_DISC_QTY, , , , False, OA_BRANDPACK_ID, , Me.GridEX2.GetValue("ACHIEVEMENT_BRANDPACK_ID").ToString())
            ElseIf IsDBNull(Me.GridEX2.GetValue("GQSY_SGT_P_FLAG")) Then
            ...
            ElseIf Not IsDBNull(Me.GridEX2.GetValue("OA_RM_ID")) Then
                ...
                NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.None, OA_BRANDPACK_DISC_QTY, , , , False, OA_BRANDPACK_ID, , , , Me.GridEX2.GetValue("OA_RM_ID").ToString())
            ElseIf Me.GridEX2.GetValue("DISCOUNT_FROM").ToString() = "OTHER DISC" Then
                ...
                For i As Integer = 0 To dtview.Count - 1
                    If dtview(i)("OA_BRANDPACK_ID").ToString() = OA_BRANDPACK_ID Then
                        If (CBool(dtview(i)("ISREMAINDING")) = True) And (dtview(i)("GQSY_SGT_P_FLAG") = "O") Then
            ...
            ElseIf Me.GridEX2.GetValue("DISCOUNT_FROM").ToString() = "ADJUSTMENT_DPD" Then
                Dim ADJUST_QTY As Decimal = IIf((IsNothing(Me.GridEX2.GetValue("ADJUST_DPD")) And (IsDBNull(Me.GridEX2.GetValue("ADJUST_DPD")))), 0, Convert.ToDecimal(Me.GridEX2.GetValue("ADJUST_DPD")))
                Me.clsOADiscount.DeleteOA_BRANDPACK_DISC(OA_BRANDPACK_DISC_ID, NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.AgreementDiscount, ADJUST_QTY, , , , , OA_BRANDPACK_ID)
            End If
...
#Region " Clearing Control "
    ...
    End Sub
    Private Sub ClearRadioButtonSales()
        Me.rdbCPDAuto.Checked = False
    ...
    Private Sub ClearRadioAgreement()
        ...
        Me.rdbSemesterly2Discount.Checked = False
...
#Region " Binding source control "
    ...
    Private Sub BindGridEx3(ByVal dtview As DataView)
        ...
        Select Case Me.SDiscount
            Case SelectedDiscount.AgreementDiscount
                If Me.rdbAjdustmentDPD.Checked Then
                    Me.GridEX3.SetDataBinding(dtview, "") : Me.GridEX3.RetrieveStructure()
                    Me.GridEX3.RootTable.Columns("ADJ_QTY").FormatString = "#,##0.000"
                    Me.GridEX3.RootTable.Columns("ADJ_QTY").TextAlignment = Janus.Windows.GridEX.TextAlignment.Far

                    Me.GridEX3.RootTable.Columns("LEFT_QTY").FormatString = "#,##0.000"
                    Me.GridEX3.RootTable.Columns("LEFT_QTY").TextAlignment = Janus.Windows.GridEX.TextAlignment.Far

                    Me.GridEX3.RootTable.Columns("RELEASE_QTY").FormatString = "#,##0.000"
                    Me.GridEX3.RootTable.Columns("RELEASE_QTY").TextAlignment = Janus.Windows.GridEX.TextAlignment.Far
    ...
    Private Sub BindGridRemainding(ByVal dtview As DataView)
        ...
        For i As Integer = 0 To dtview.Count - 1
            ...
            ElseIf dtview(i)("FLAG") = "DP" Then
                dtview(i)("LEFT_QTY_FROM") = "ADJUSTMENT_DPD"
            Else
...
#Region " Showing Ballon form (edit quantity) "
    ...
    Private Sub lnkOK_Click(ByVal sender As Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles QTY.lnkClick
        Try
            ...
            Dim tblAdjustment As DataTable = Me.CreateOrReCreateTblAdjustment()
                        ...
                        If (Convert.ToDecimal(Me.QTY.txtAdjust1.Value) + Convert.ToDecimal(Me.QTY.txtAdjust2.Value)) < Me.QTY.NumericEditBox1.Value Then
                            If totalQty Mod Devided_Qty > 0 Then
                                ...
                                If hasChildTrans Then 'yang masuk ke remainding adalah yang 
                                    Me.clsOADiscount.InsertAdjustment(True, True, True, PrimaryIdent, True)
                            ...
                            Else
                                ...
                                If hasChildTrans Then
                                    Me.clsOADiscount.InsertAdjustment(False, True, True, PrimaryIdent, True)
                                End If
                            End If
                        Else
            ...
            Me.pnlTotalRemainder.Text = String.Format("Still Remainder = {0:#,##0.000} " & Unit & ", = {1:#,##0.000} " & UnitOnOrder, LEFT_QTY * Devide_Factor, LEFT_QTY)
    ...
    Private Sub Other_QTY_lnkCancelClick(ByVal sender As Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles Other_QTY.lnkCancelClick
        Try
            Me.Other_QTY.Close()
    ...
    Private Sub Other_QTY_lnkOKClick(ByVal sender As Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles Other_QTY.lnkOKClick
        Try
            Me.Cursor = Cursors.WaitCursor
            If Me.Other_QTY.txtPercentage.Value Is Nothing Then
                Me.ShowMessageInfo("Invalid Data !" & vbCrLf & "System can not process invalid data." & vbCrLf & "Data can not be null / zero.")
                Me.Other_QTY.Show(Me.pnlOADiscount, True)
                Return
            ElseIf Me.Other_QTY.txtResult.Value = 0 Then
                Me.ShowMessageInfo("Invalid Data !" & vbCrLf & "System can not process invalid data." & vbCrLf & "Data can not be null / zero.")
                Me.Other_QTY.Show(Me.pnlOADiscount, True)
                Return
            End If
            ...
            Dim LeftQTY As Decimal = Me.Other_QTY.txtResult.Value Mod Me.Devided_Qty
            Dim ResultQTY As Decimal = (Decimal.Truncate(Me.Other_QTY.txtResult.Value / Me.Devided_Qty)) * Me.Devided_Qty
            'BAGILANGSUNG DENGAN QUANTITY(LITRE)/KG
            If (ResultQTY = 0) And (LeftQTY = 0) Then
                Me.ShowMessageInfo("Can not proceed data with 0 value")
                Me.Other_QTY.Show(Me.pnlOADiscount)
                Return
            End If

            PRICE = Convert.ToDecimal(Me.GridEX1.GetValue("OA_PRICE_PERQTY"))
            ...
            If LeftQTY > 0 Then
                ...
                Me.clsOADiscount.InsertOA_BRANDPACK_DISC(ResultQTY, LeftQTY, OA_BRANDPACK_ID)
            ...
            ElseIf ResultQTY > 0 Then
                ...
                Me.Other_QTY.txtResult.Value, , , , True, Me.GridEX1.GetValue("OA_BRANDPACK_ID").ToString())
            End If
            Me.SFG = StateFillingGrid.Filling
            ...
            Me.pnlTotalRemainder.Text = String.Format("Still Remainder = {0:#,##0.000} " & Unit & ", = {1:#,##0.000} " & UnitOnOrder, LEFT_QTY * Devide_Factor, LEFT_QTY)
            Me.SFG = StateFillingGrid.HasFilled
            Me.Other_QTY.Close() : Me.Other_QTY = Nothing

            'Me.GridEX1.Row = IndexRow
        Catch ex As Exception
            Me.ShowMessageInfo(ex.Message)
            Me.LogMyEvent(ex.Message, Me.Name + "_Other_QTY_lnkOKClick")
            Me.Other_QTY.Close()
            Me.Other_QTY = Nothing
        Finally
                ...
                If Me.DDF = DataDragFrom.GridEx3 Then
                    Select Case Me.SDiscount
                        Case SelectedDiscount.AgreementDiscount
                            ...
                            ElseIf Me.rdbAjdustmentDPD.Checked Then : .FLAG = "DP" : Flag = "DP"
                            End If
                    ...
                    If Me.DDT = DataDragTo.GridEx2 Then
                        ...
                        If index <> -1 Then
                            If Me.LftQTY.txtQty.Value > Me.LftQTY.RemaindingQty Then
                                Me.ShowMessageInfo("Quantity that shall be given,is more than it should be")
                            ...
                            With Me.clsOADiscount.OA_BRANDPACK_DISCOUNT
                                ...
                                Select Case Me.grdRemainding.GetValue("FLAG").ToString()
                                    Case "MG", "KP", "CP", "CS", "CD", "CT", "TS", "TD", "CR", "DK", "MS", "MT", "DN", "CA", "RMOA", "G", "Q1", "Q2", "Q2", "Q3", "Q4", "S1", "S2", "Y", "DP"
                                        Me.clsOADiscount.InsertOA_BRANDPACK_DISC(NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.None, _
                                        OrgDecimalValue, , , , False, Me.GridEX1.GetValue("OA_BRANDPACK_ID").ToString())
                                    Case "O"
                                        Me.clsOADiscount.InsertOA_BRANDPACK_DISC(NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.None, _
    ...
    Private Sub EQTY_OKClick(ByVal sender As Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles EQTY.OKClick
        Try
            If Me.EQTY.txtQTY.Value <= 0 Then : Return : End If
            Me.Cursor = Cursors.WaitCursor
            Dim IndexRow As Integer = Me.GridEX1.Row
            Dim IndexCol As Integer = Me.GridEX1.Col
            ...
            If Me.EQTY.txtQTY.Value = Me.EQTY.OrgDecimalValue Then
                ...
                If Me.clsOADiscount.hasExistedInSPPBBrandPack(Me.GridEX1.GetValue("OA_BRANDPACK_ID").ToString(), False) Then
                    Me.ShowMessageInfo("Can not delete data when sppb has already been created") : Return
                End If
            ...
            If Not Me.GridEX2.GetValue("OA_RM_ID") Is DBNull.Value And Not IsNothing(Me.GridEX2.GetValue("OA_RM_ID")) Then
                ...
                Select Case FLAG
                    ...
                    Case "O"
                        Me.clsOADiscount.Update_OABRANDPACK_DISC(OA_BRANDPACK_DISC_ID, BRANDPACK_ID, OA_BRANDPACK_ID, QTY, "O", _
                                                    Me.GridEX2.GetValue("OA_RM_ID").ToString(), , , "", , , , True)
                    Case "G"
                        Me.clsOADiscount.Update_OABRANDPACK_DISC(OA_BRANDPACK_DISC_ID, BRANDPACK_ID, OA_BRANDPACK_ID, QTY, "G", _
                                                   Me.GridEX2.GetValue("OA_RM_ID").ToString(), , , "", , , , False)
                    Case "RMOA"
                        Me.clsOADiscount.Update_OABRANDPACK_DISC(OA_BRANDPACK_DISC_ID, BRANDPACK_ID, OA_BRANDPACK_ID, QTY, "RMOA", _
                       Me.GridEX2.GetValue("OA_RM_ID").ToString(), , , "", , , , False)
                End Select
            ...
            ElseIf Me.GridEX2.GetValue("GQSY_SGT_P_FLAG").ToString() = "O" Then
                Me.clsOADiscount.Update_OABRANDPACK_DISC(OA_BRANDPACK_DISC_ID, BRANDPACK_ID, OA_BRANDPACK_ID, QTY, "", , _
                                       , , "", , , , True)
            ElseIf FLAG = "DP" Then
                Me.clsOADiscount.Update_OABRANDPACK_DISC(OA_BRANDPACK_DISC_ID, BRANDPACK_ID, OA_BRANDPACK_ID, QTY, FLAG, , _
...
#Region " CHECKING AVAILABILITY DISCOUNT "
    Private Sub CheckAvailabilityDisocunt(ByVal DISTRIBUTOR_ID As String, ByVal BRANDPACK_ID As String, ByVal OA_DATE As Object, ByVal SDiscount As SelectedDiscount)
        ...
        Select Case SDiscount
            Case SelectedDiscount.AgreementDiscount
                Me.clsOADiscount.CheckAvailabilityDisc(Convert.ToDateTime(DateTime.Parse(Me.txtOARefDate.Text)), _
                DISTRIBUTOR_ID, BRANDPACK_ID, NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.AgreementDiscount, False)

            Case SelectedDiscount.MarketingDiscount
                Me.clsOADiscount.CheckAvailabilityDisc(Convert.ToDateTime(DateTime.Parse(Me.txtOARefDate.Text)), _
                               DISTRIBUTOR_ID, BRANDPACK_ID, NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.MarketingDiscount, False)
            Case SelectedDiscount.None
            Case SelectedDiscount.OtherDiscount
            Case SelectedDiscount.ProjectDiscount
        End Select
        ...
        Me.rdbAjdustmentDPD.Enabled = Me.clsOADiscount.IsgeneratedAgreement.DP
    ...
    Private Sub setUnabledRadioButton()
        ...
        If Not Me.rdbSemesterly2Discount.Enabled Then : Me.rdbSemesterly2Discount.Checked = False : End If
        ...
        If Not Me.rdbAjdustmentDPD.Enabled Then : Me.rdbAjdustmentDPD.Checked = False : End If
    End Sub
    ...
    Private Sub unabledRadioButton()
        ...
        Me.rdbAjdustmentDPD.Enabled = False
    End Sub
#End Region
...
#Region " Form Event "
    ...
    Private Sub OA_BrandPack_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        Try
            Me.Cursor = Cursors.WaitCursor
        ...
        Catch ex As Exception
            ...
            Me.LogMyEvent(ex.Message, Me.Name + "_OA_BrandPack_Load")
        Finally
            Me.ReadAcces()
            Me.HasLoad = True
            Me.SFG = StateFillingGrid.HasFilled
    ...
    Private Sub OA_BrandPack_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        Try
            Me.Cursor = Cursors.WaitCursor
...
#Region " Button "
                    ...
                    Select Case Me.Mode
                        Case ModeSave.Save
                            If Not CMAin.IsSystemAdministrator Then
                                If NufarmBussinesRules.User.Privilege.ALLOW_INSERT.OA_BrandPack = True Then
                                    If Me.clsOADiscount.IsExistedOABrandPack(OA_BRANDPACK_ID) = True Then
                        ...
                        Case ModeSave.Update
                            If Not CMAin.IsSystemAdministrator Then
                                If NufarmBussinesRules.User.Privilege.ALLOW_UPDATE.OA_BrandPack = True Then
    ...
    Private Sub btnSetOtherDiscount_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSetOtherDiscount.Click
        Try
    ...
    Private Sub btnInsertSystem_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnInsertSystem.Click
        Try
            ...
            End If
            'KALIKAN QUANTITY DENGAN PRICE
            Dim TotalRelDisc As Decimal = Me.clsOADiscount.getTotalQTY(Me.GridEX1.GetValue("OA_BRANDPACK_ID"), False)
            Dim LeftQTY As Decimal = TotalRelDisc Mod Devided_Qty
            Dim TOTAL As Decimal = Convert.ToDecimal(Me.grdRemainding.GetTotal(Me.grdRemainding.RootTable.Columns("LEFT_QTY"), Janus.Windows.GridEX.AggregateFunction.Sum, _
                 Nothing))
            Dim MinusDevidedQty As Decimal = 0 'untuk mengetahu kekurangan nya discount agar genap
            Dim lastRemain As Decimal = 0 'Nilai decimal dari remain yang tidak bisa di ambil
            If LeftQTY > 0 Then
            ...
            If (AmountPrice + Convert.ToDecimal(SUMPRICE)) > DISC_PRICE_OA Then
                Me.ShowMessageInfo("Value will be more than should be released" & vbCrLf & "Discount price for OA " & _
                Me.mcbRefNo.Value.ToString() & " has " & String.Format("{0:#,##0.00}", SUMPRICE) & vbCrLf & "Amount that will be given is : " & _
                String.Format("{0:#,##0.00}", AmountPrice) & vbCrLf & "Amount that can be released for BrandPack " & Me.GridEX1.GetValue("BRANDPACK_NAME").ToString() & " = " & String.Format("{0:#,##0.000}", LEFT_QTY_PRICE) & vbCrLf & _
                "Amount that will be released = " & String.Format("{0:#,##0.00}", AmountPrice))
                'Me.Other_QTY.Show(Me.pnlOADiscount)
                Return
            End If
            Dim dtview As DataView = CType(Me.grdRemainding.DataSource, DataView)
            Me.clsOADiscount.RecalCulateQTY(dtview, OA_BRANDPACK_ID, ResultQty, PRICE, Me.txtPOREFNO.Text)
            'bikin table
    ...
    Private Sub btnPrint_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnPrint.Click
        Try
            ...
            frmPrintOA.InitializeData(Me.mcbRefNo.Value.ToString())
    ...
    Private Sub rdbPeriodDiscount1_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbPeriodDiscount1.CheckedChanged
        Try
            ...
            If Me.rdbPeriodDiscount1.Checked = True Then
                Me.rdbAjdustmentDPD.Checked = False
                Me.btnGenerateAgreement.Enabled = False
                If Me.GridEX1.SelectedItems.Count = 0 Then
                    Me.ShowMessageInfo("Please select BrandPack Name from InsertedOABrandPack" & vbCrLf & "System will Show all Left quantity BrandPack" & vbCrLf & "Based on BrandPack Name you select" _
                                       & vbCrLf & "And DISTRIBUTOR'S PO")
            ...
            Select Case Me.NavigationPane1.CheckedButton.Name
                Case "btnAgreement"
                    ...
                    If Not Me.isPOProject Then
                        ...
                        ElseIf Me.rdbAjdustmentDPD.Checked Then
                            Me.rdbAjdustmentDPD_CheckedChanged(Me.rdbAjdustmentDPD, New EventArgs())
                        End If
...
#Region " GridEx1 "
    ...
    Private Sub GridEX1_CurrentCellChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles GridEX1.CurrentCellChanged
        Try
            ...
            If Not Me.isPOProject Then
                Me.CheckAvailabilityDisocunt(Me.DistributorID, BRANDPACK_ID, DateTime.Parse(Me.txTPOREFDATE.Text), SDiscount)
                If (SDiscount <> SelectedDiscount.AgreementDiscount And SDiscount <> SelectedDiscount.MarketingDiscount) Then
            ...
            Me.pnlTotalRemainder.Text = String.Format("Still Remainder = {0:#,##0.000} " & Unit & ", = {1:#,##0.000} " & UnitOnOrder, LeftQty * Devide_Factor, LeftQty)
        Catch ex As Exception
            Me.ShowMessageError(ex.Message)
    ...
    Private Sub GridEX1_MouseDoubleClick(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles GridEX1.MouseDoubleClick
        Try
            Me.Cursor = Cursors.WaitCursor
            If Not CMAin.IsSystemAdministrator Then
                If Not NufarmBussinesRules.User.Privilege.ALLOW_DELETE.OA_BrandPack = True Then
                    Return
                End If
            End If
            If Me.GridEX1.GetRow().RowType = Janus.Windows.GridEX.RowType.Record Then
                ...
                Else
                    ...
                    'delete dataview
                    'Me.InflateDataFromMCB(Me.mcbRefNo)
                    'Me.InflateDataFromMCB(Me.mcbRefNo)
                    'CType(Me.GridEX1.DataSource, DataView).Table.AcceptChanges()
                    'Me.mcbRefNo.Text = ""
                    'Me.mcbBrandPack.Text = ""
...
#Region " GridEx2 "
    ...
    Private Sub GridEX2_CurrentCellChanged(ByVal sender As Object, ByVal e As System.EventArgs) Handles GridEX2.CurrentCellChanged
        Try
            ...
            If Me.GridEX2.GetRow.RowType = Janus.Windows.GridEX.RowType.Record Then
                ...
                Me.baseTooltip.Show(Me.GridEX2.GetValue("DISC_DESCRIPTION").ToString(), Me.GridEX2, 3000)
            End If
        Catch ex As Exception
    ...
    Private Sub GridEX2_MouseDoubleClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles GridEX2.MouseDoubleClick
        Try
            ...
            If Me.GridEX2.GetRow.RowType = Janus.Windows.GridEX.RowType.Record Then
                ...
                End If
                Me.EQTY = New EditQTY()
                Dim Flag As String = Me.GridEX2.GetValue("DISCOUNT_FROM")
                If Flag = "ADJUSTMENT_DPD" Then
                    EQTY.OrgDecimalValue = Convert.ToDecimal(Me.GridEX2.GetValue("ADJUST_DPD"))
                Else
    ...
    Private Sub GridEX2_DeletingRecord(ByVal sender As System.Object, ByVal e As Janus.Windows.GridEX.RowActionCancelEventArgs) Handles GridEX2.DeletingRecord
        ...
        End Try
    End Sub
    Private Sub AdjustmentCancel(ByVal sender As System.Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles frmAdjDPD.CancelClick
        Me.frmAdjDPD.Close()
        Me.frmAdjDPD.Dispose() : Me.frmAdjDPD = Nothing
    End Sub
        ...
        Try
            ...
            If Me.DDF = DataDragFrom.GridEx3 Then
                ...
                Select Case Me.SDiscount
                    Case SelectedDiscount.AgreementDiscount
                        If Me.rdbAjdustmentDPD.Checked Then
                            If IsNothing(Me.frmAdjDPD) OrElse Me.frmAdjDPD.IsDisposed Then
                                Me.frmAdjDPD = New AdjDPDQTY()
                                ResultQTY = (Decimal.Truncate(Convert.ToDecimal(Me.GridEX3.GetValue("LEFT_QTY")) / Devided_Qty)) * Devided_Qty
                                Me.frmAdjDPD.txtQuantity.Value = ResultQTY
                                frmAdjDPD.MaxQty = Convert.ToDecimal(Me.GridEX3.GetValue("LEFT_QTY"))
                                frmAdjDPD.ShowDialog()
                            End If
                            : Me.Cursor = Cursors.Default : Return
                        Else
                            ''===========SHOW FORM QUANTITY====================
...
#Region " GridEx3 "
            ...
            Select Case Me.SDiscount
                Case SelectedDiscount.AgreementDiscount
                    If Me.rdbGivenDiscount.Checked = True Then
                        ...
                        e.Cancel = False
                    Else
                        Me.ShowMessageInfo("this kind of Discount can not be deleted" & vbCrLf & "Only given Discount can be deleted.")
                        e.Cancel = True
                        Return
                    End If
                Case SelectedDiscount.MarketingDiscount
                    If (Me.rdbGivenDiscountMarketing.Checked = True) Or (Me.rdbGivenCP.Checked) Or _
                       ...
                       Or (Me.rdbCPMRT_Dist.Checked = True) Or (Me.rdbCPMRT_TMDist.Checked = True) Or (Me.rdbDKN.Checked) Or (Me.rdbCPDAuto.Checked) Then
                        ...
                        If (e.Row.Cells("SGT_FLAG").Value.ToString() = "CP(D)_DIST") Or (e.Row.Cells("SGT_FLAG").Value.ToString() = "CP(D)_DIST_TM") Then
                            ...
                            Dim TargetCP As Decimal = 0, GivenDisc As Decimal = 0, IsTTMDist As Boolean = False, DiscMustQty As Decimal = 0, DiscQty As Decimal = Convert.ToDecimal(e.Row.Cells("MRKT_DISC_QTY"))
    ...
    Private Sub GridEX3_DragDrop(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles GridEX3.DragDrop
    ...
    Private Sub GridEX3_MouseDown(ByVal sender As Object, ByVal e As System.Windows.Forms.MouseEventArgs) Handles GridEX3.MouseDown
        Try
            ...
            If e.Button = Windows.Forms.MouseButtons.Left Then
                Me.DDF = DataDragFrom.GridEx3
                Me.GridEX3.DoDragDrop(Me.GridEX3.GetValue(0).ToString(), DragDropEffects.Copy)
            End If
        Catch ex As Exception
...
#Region " grdRemainding "
    ...
    Private Sub grdRemainding_DragDrop(ByVal sender As Object, ByVal e As System.Windows.Forms.DragEventArgs) Handles grdRemainding.DragDrop
        Try
            ...
            Dim QtyToInsert As Decimal = 0 'Convert.ToDecimal(Me.GridEX3.GetValue(colLeftQTY)) Mod Me.Devided_Qty
            With Me.clsOADiscount.OA_Remainding
                If Me.DDF = DataDragFrom.GridEx3 Then
                    Dim tblAdjustment As DataTable = Nothing
                    Select Case Me.SDiscount
                        Case SelectedDiscount.AgreementDiscount
                            If Me.rdbGivenDiscount.Checked Then : Flag = "G" : .FLAG = "G"
                            ElseIf Me.rdbPeriodDiscount1.Checked Then : .FLAG = "Q1" : Flag = "Q1"
                            ...
                            ElseIf Me.rdbAjdustmentDPD.Checked Then : .FLAG = "DP" : Flag = "DP"
                                ''isi tblAdjustment
                                Me.Cursor = Cursors.WaitCursor
                                QtyToInsert = Convert.ToDecimal(Me.GridEX3.GetValue("LEFT_QTY"))
                                If QtyToInsert <= 0 Then : Return : End If
                                tblAdjustment = Me.CreateOrReCreateTblAdjustment()
                                Dim newRow As DataRow
                                newRow = tblAdjustment.NewRow()
                                newRow("IDApp") = Me.GridEX3.GetValue("IDApp")
                                newRow("ReleaseQty") = QtyToInsert
                                newRow("PO_REF_NO") = Me.txtPOREFNO.Text
                                newRow("IsRemain") = True
                                newRow.EndEdit()
                                newRow = tblAdjustment.NewRow()
                                ...
                                .MRKT_M_S_ID = DBNull.Value
                                .OA_BRANDPACK_ID = OA_BRANDPACK_ID
                                .PRICE_PRQTY = Me.txtPrice.Value
                                .PROJ_DISC_HIST_ID = DBNull.Value
                                .RM_OA_ID = DBNull.Value
                                Me.clsOADiscount.InsertAdjustment(True, True, True, DBNull.Value, False)
                                Me.GridEX1.Row = IndexRow
                                Me.GridEX1_CurrentCellChanged(Me.GridEX1, New EventArgs())
                                Me.Cursor = Cursors.Default
                                Return
                    ...
                    Me.Cursor = Cursors.WaitCursor
                    QtyToInsert = Convert.ToDecimal(Me.GridEX3.GetValue(colLeftQTY)) Mod Me.Devided_Qty
                    If QtyToInsert <= 0 Then : Return : End If
                    Me.DDT = DataDragTo.GridRemainding
                    'CHECK APAKAH DATA SUDAH DI INSERT / BELUM
                    'JIKA SUDAH UPDATE DATA
                    Select Case Me.SDiscount
                        Case SelectedDiscount.None ''tidak ada item remaining hanya menampilkan data remaining
    ...
    Private Sub grdRemainding_DeletingRecord(ByVal sender As System.Object, ByVal e As Janus.Windows.GridEX.RowActionCancelEventArgs) Handles grdRemainding.DeletingRecord
        Try
            ...
            If Me.ShowConfirmedMessage(Me.ConfirmDeleteMessage) = Windows.Forms.DialogResult.Yes Then
                ...
                Dim AchivementBrandPackID As Object = DBNull.Value
                Select Case Me.grdRemainding.GetValue("FLAG")
                    ...
                    Case "Q1", "Q2", "Q3", "Q4", "S1", "S2", "Y"
                        ...
                        Else
                            If Me.grdRemainding.GetValue("FLAG") <> "DP" Then
                                AchivementBrandPackID = Me.grdRemainding.GetValue("ACHIEVEMENT_BRANDPACK_ID").ToString()
                            End If
                            Me.clsOADiscount.Delete_OA_Remainding(Me.grdRemainding.GetValue("OA_RM_ID").ToString(), _
                                                     NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.AgreementDiscount, _
                                                     QTY, , , , False, _
                                                     Me.grdRemainding.GetValue("OA_BRANDPACK_ID").ToString(), , AchivementBrandPackID)
                        End If
        ...
        Try
            ...
            If e.Button = Windows.Forms.MouseButtons.Right Then
                ...
                If Me.ShowConfirmedMessage(Me.ConfirmDeleteMessage) = Windows.Forms.DialogResult.Yes Then
                    ...
                    Dim indexCol As Integer = Me.GridEX1.Col
                    Dim Qty As Decimal = Convert.ToDecimal(Me.grdRemainding.GetValue("LEFT_QTY"))
                    Dim AchivementBrandPackID As String = ""
                    Select Case Me.grdRemainding.GetValue("FLAG")
                        Case "G"
                            Me.clsOADiscount.Delete_OA_Remainding(Me.grdRemainding.GetValue("OA_RM_ID").ToString(), _
                             NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.AgreementDiscount, _
...
#End Region
    ...
    Private Sub rdbCPDAuto_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbCPDAuto.Click
        Try
            ...
            Me.Cursor = Cursors.Default
        Catch ex As Exception
            Me.LogMyEvent(ex.Message, Me.Name + "_rdbDKN_Click") : Me.ShowMessageInfo(ex.Message) : Me.Cursor = Cursors.Default
        End Try
    End Sub
    ...
    Private Sub rdbAjdustmentDPD_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles rdbAjdustmentDPD.CheckedChanged
        Try

            If Me.rdbAjdustmentDPD.Checked = True Then
                Me.ClearRadioAgreement()
                Me.btnGenerateAgreement.Enabled = False
                If Me.GridEX1.SelectedItems.Count = 0 Then
                    Me.ShowMessageInfo("Please select BrandPack Name from InsertedOABrandPack" & vbCrLf & "System will Show all Left quantity BrandPack" & vbCrLf & "Based on BrandPack Name you select" _
                                       & vbCrLf & "And DISTRIBUTOR'S PO")
                ...
                Else : MustcloseConnection = True
                End If
                Dim DV As DataView = Me.clsOADiscount.CreateViewAdjustmentDPD(Me.GridEX1.GetValue("BRANDPACK_ID").ToString(), Me.clsOADiscount.DISTRIBUTOR_ID, Convert.ToDateTime(Me.txTPOREFDATE.Text), MustcloseConnection)
                Me.BindGridEx3(DV)

            End If
        Catch ex As Exception
            Me.ShowMessageInfo(ex.Message) : Me.LogMyEvent(ex.Message, Me.Name + "_rdbAjdustmentDPD_CheckedChanged")
        Finally
            If Me.QData = QueryData.GridSelected Or Me.QData = QueryData.NavigationPanel Then : Me.Cursor = Cursors.WaitCursor : Else : Me.Cursor = Cursors.Default : End If
        End Try
    End Sub
    ''' <summary>
    ''' Create data table Adjusment with columns IDApp,ReleaseQty,ABID,PO_REF_NO,IsRemain
    ''' </summary>
    ''' <returns>Data table</returns>
    ''' <remarks></remarks>
    Private Function CreateOrReCreateTblAdjustment() As DataTable
    ...
    End Function
    Private Sub frmAdjDPD_lnkClick(ByVal sender As Object, ByVal e As System.Windows.Forms.LinkLabelLinkClickedEventArgs) Handles frmAdjDPD.lnkClick
        Try
            If (Me.mcbRefNo.Value Is Nothing) Or (Me.mcbRefNo.SelectedItem Is Nothing) Then
                Me.ShowMessageInfo("Please define OA_REF_NO to compute by system") : Return
            End If
            If Me.GridEX1.RecordCount <= 0 Then
                Me.ShowMessageInfo("Please define Brandpack name") : Return
            End If
            If Me.GridEX1.SelectedItems.Count = 0 Then
                Me.ShowMessageInfo("Please define Brandpack name") : Return
            End If
            ...
            End If
            If IsDBNull(Me.GridEX1.GetValue("OA_PRICE_PERQTY")) Then
                Me.ShowMessageInfo("PRICE for that brandpack is null") : Return
            End If
            Dim PRICE As Decimal = Convert.ToDecimal(Me.GridEX1.GetValue("OA_PRICE_PERQTY"))
            If IsDBNull(PRICE) Then
                Me.ShowMessageInfo("PRICE for that brandpack is null") : Return
            ...
            'ambil price yang ada di pnl oa_discount
            Dim ResultQty As Decimal = Me.frmAdjDPD.txtQuantity.Value
            Dim PrimaryIdent As Integer = 0 'OA_BRANDPACK_DISC_ID
            Dim AmountPrice As Decimal = PRICE * ResultQty  'KALIKAN QUANTITY DENGAN PRICE
            Dim DISC_PRICE_OA As Decimal = 0
            ...
            Dim OA_BRANDPACK_ID As Object = Me.GridEX1.GetValue("OA_BRANDPACK_ID")
            Dim BRANDPACK_ID As String = Me.GridEX1.GetValue("BRANDPACK_ID").ToString()
            Dim BRANDPACK_NAME As String = Me.GridEX1.GetValue("BRANDPACK_NAME").ToString()
            Dim x As String = ""
            Dim w As Integer = Me.pnlOADiscount.TitleText.IndexOf(":") + 3
            Dim s As String
            Dim a As String = ""
            ...
            Dim SUMPRICE As Object = Me.clsOADiscount.GetTotalPriceOAGiven(Me.mcbRefNo.Value.ToString(), False) 'TOTAL DISCOUNT YG TELAH DIBERIKAN
            Dim TOTAL_LEFT_PRICE As Decimal = DISC_PRICE_OA - Convert.ToDecimal(SUMPRICE)
            Dim LEFT_QTY As Decimal = TOTAL_LEFT_PRICE / Convert.ToDecimal(PRICE)
            If (AmountPrice + SUMPRICE) > DISC_PRICE_OA Then
                Me.ShowMessageInfo("Value will be more than should be given" & vbCrLf & "Discount price for OA " & _
                Me.mcbRefNo.Value.ToString() & " has " & String.Format("{0:#,##0.00}", SUMPRICE) & vbCrLf & "Amount that will be given is : " & _
                String.Format("{0:#,##0.00}", AmountPrice) & vbCrLf & "Amount that can be released for BrandPack " & BRANDPACK_NAME & " = " & String.Format("{0:#,##0.000}", LEFT_QTY))
                Me.Other_QTY.Show(Me.pnlOADiscount)
                Return
            End If
            ...
            Me.SFG = StateFillingGrid.Filling
            ''insert 
            Dim leftQTY As Decimal = ResultQty Mod Devided_Qty
            'jika 
            'OA_BRANDPACK_DISC_QTY = 0 ''karena ini bukan discount tapi adjustment
            With Me.clsOADiscount.OA_BRANDPACK_DISCOUNT
                .MRKT_DISC_HIST_ID = DBNull.Value
                .OA_BRANDPACK_ID = OA_BRANDPACK_ID
                .MRK_M_S_ID = DBNull.Value
                ...
                .BRANDPACK_NAME = BRANDPACK_NAME
                .PO_REF_NO = Me.txtPOREFNO.Text
                .PO_REF_DATE = Convert.ToDateTime(Me.txTPOREFDATE.Text)
            End With
            PrimaryIdent = Me.clsOADiscount.InsertOA_BRANDPACK_DISC(NufarmBussinesRules.OrderAcceptance.OADiscount.SelectedDiscount.AgreementDiscount, _
                                                                      0, , , , False, OA_BRANDPACK_ID, True)
            Dim newRow As DataRow = Nothing
            If leftQTY > 0 Then
                newRow = tblAdjustment.NewRow()
                newRow("IDApp") = Me.GridEX3.GetValue("IDApp")
                ...
                newRow = tblAdjustment.NewRow()
                newRow("IDApp") = Me.GridEX3.GetValue("IDApp")
                newRow("ReleaseQty") = ResultQty - leftQTY
                newRow("PO_REF_NO") = Me.txtPOREFNO.Text
                newRow.EndEdit()
                tblAdjustment.Rows.Add(newRow)
                With Me.clsOADiscount.OA_Remainding
                    ...
                    .RM_OA_ID = DBNull.Value
                End With
                Me.clsOADiscount.InsertAdjustment(True, True, True, PrimaryIdent, False)
                ''insert ke OA Remainding dan Adjustment Trans             
            Else
                ''insert hanya ke adjustment trans saja
                newRow = tblAdjustment.NewRow()
                newRow("IDApp") = Me.GridEX3.GetValue("IDApp")
                newRow("ReleaseQty") = ResultQty
                newRow("PO_REF_NO") = Me.txtPOREFNO.Text
                newRow.EndEdit()
                tblAdjustment.Rows.Add(newRow)
                With Me.clsOADiscount.OA_Remainding
                    ...
                    .RM_OA_ID = DBNull.Value
                End With
                Me.clsOADiscount.InsertAdjustment(False, True, True, PrimaryIdent, False)
            End If
            Me.SFG = StateFillingGrid.HasFilled
            Me.NavigationPane1_ItemClick(Me.NavigationPane1, New EventArgs())
            Me.clsOADiscount.CreateViewOABrandPackDiscount(OA_BRANDPACK_ID, False)
            Me.BindGridEx(Me.GridEX2, Me.clsOADiscount.ViewOADiscount) : Me.SFG = StateFillingGrid.HasFilled
            Dim UnitOnOrder As String = ""
            If Not IsDBNull(Me.GridEX1.GetValue("UNIT_ORDER")) Then
                UnitOnOrder = Me.GridEX1.GetValue("UNIT_ORDER").ToString()
            End If
            Dim OrgDecimalValue As Decimal = Me.clsOADiscount.getTotalQTY(OA_BRANDPACK_ID, True)
            LEFT_QTY = OrgDecimalValue Mod Devided_Qty
            Me.pnlTotalRemainder.Text = String.Format("Still Remainder = {0:#,##0.000} " & Unit & ", = {1:#,##0.000} " & UnitOnOrder, LEFT_QTY * Devide_Factor, LEFT_QTY)
            Me.frmAdjDPD.Close()
            Me.frmAdjDPD = Nothing
            Me.Cursor = Cursors.Default
        Catch ex As Exception
            Me.ShowMessageInfo(ex.Message) : Me.LogMyEvent(ex.Message, Me.Name + "_frmAdjDPD_lnkClick") : Me.Cursor = Cursors.Default
        End Try
    End Sub
End Class
