...
Public Class OA_Per_ID
    ...
    '    Get
    '        Return "DTSProjects.OA_Per_ID.rpt"
    '    End Get
    '    Set
    '        'Do nothing
    '    End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_OA_REF_NO() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedOA_Per_ID
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As OA_Per_ID = New OA_Per_ID
        rpt.Site = Me.Site
        Return rpt
    End Function
