...
SELECT * FROM NI109.dbo.ICCATG WHERE [desc] LIKE '%SUMI BOXAM%'

SELECT * FROM NI109.dbo.ICITEM WHERE [desc] LIKE '%BOkSAM%'
...
SELECT * FROM dprd.dbo.uv_kios WHERE IDKios Like '%038/4790/VENUS%'
