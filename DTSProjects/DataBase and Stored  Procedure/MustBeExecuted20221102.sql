...
GT.TRANSPORTER_NAME, GSH.POLICE_NO_TRANS,GSH.DRIVER_TRANS,GSD.QTY AS QUANTITY,CONVERT(VARCHAR(20),GSD.QTY) + ' ' + BP.UNIT AS QUANTITY_UNIT,GSD.COLLY_BOX,GSD.COLLY_PACKSIZE,GSD.BATCH_NO,
