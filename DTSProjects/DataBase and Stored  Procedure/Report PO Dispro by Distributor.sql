...
--           	  FROM NI109.dbo.OEINVH INVH INNER JOIN NI87.dbo.OEINVD INVD ON INVH.INVUNIQ = INVD.INVUNIQ
--           	  LEFT OUTER JOIN
--                         (
...
--                                    FROM NI87.DBO.OECRDD WHERE LINETYPE = 1 AND ACCTSET = 'FG' OR RTRIM(ACCTSET) = 'FGST' OR RTRIM(ACCTSET) = 'FGTOLL'
