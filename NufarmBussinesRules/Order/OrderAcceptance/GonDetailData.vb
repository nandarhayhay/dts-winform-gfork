        ...
        Public Function getDTSPPBGON(ByVal MasterCategory As String, ByVal CustomCategory As String, ByVal PONumber As String, ByVal SPPBNO As Object, ByVal GONNUmber As Object, ByVal FromDate As Object, ByVal UntilDate As Object, ByVal MustReloadData As Boolean, ByRef TblConv As DataTable) As DataTable
            ...
            Try
                ...
                Query = "SET NOCOUNT ON; SET ARITHABORT OFF; SET ANSI_WARNINGS OFF ; " & vbCrLf & _
                        ...
                        " TFR.DEVIDED_QUANTITY,TFR.PO_ORIGINAL_QTY,TFR.PO_ORIGINAL_AMOUNT,TFR.TOTAL_DISC,TFR.TOTAL_DISC* TFR.PRICE AS TOTAL_DISC_AMOUNT,TFR.SPPB_QTY,GD.GON_QTY,GD.GON_QTY*TFR.PRICE AS GON_QTY_AMOUNT,TFR.TOTAL_GON," & vbCrLf & _
                        ...
                        " WHEN (TOTAL_GON > 1) THEN 0 ELSE 0 END,GON_PO_AMOUNT = CONVERT(DECIMAL(18,4),0),GON_DISC_INC_AMOUNT = CONVERT(DECIMAL(18,4),0),GD.BatchNo,GH.WARHOUSE,GH.POLICE_NO_TRANS,GH.DRIVER_TRANS," & vbCrLf & _
